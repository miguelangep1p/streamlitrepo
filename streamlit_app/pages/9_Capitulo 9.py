...
st.set_page_config(
    page_title="Capítulo 9 - Reconocimiento de Objetos",
    page_icon="🤖",
    layout="wide",
)
...
# ======== TÍTULO ========
st.markdown("<h1 class='main-title'>🤖 Reconocimiento de Objetos</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Entrena y clasifica objetos usando Machine Learning</p>", unsafe_allow_html=True)

# ======== ARCHIVOS ========
files = {
    "./chapter9/prueba1.py": {"name": "Detectar Características Densas", "icon": "🔬"},
    "./chapter9/prueba2.py": {"name": "Crear Mapa de Características", "icon": "🗺️"},
    "./chapter9/prueba3.py": {"name": "Entrenar Modelo SVM", "icon": "🧠"},
    "./chapter9/prueba4.py": {"name": "Realizar Clasificación", "icon": "✅"}
}
...
st.markdown("""
    <div class='footer'>
        <strong>Capítulo 9</strong> — Reconocimiento de Objetos con OpenCV y Machine Learning<br>
        Clasificación inteligente mediante SVM
    </div>
""", unsafe_allow_html=True)