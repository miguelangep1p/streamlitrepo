...
st.set_page_config(
    page_title="Capítulo 5 - Extracción de Características",
    page_icon="🔍",
    layout="wide",
)
...
# ======== TÍTULO ========
st.markdown("<h1 class='main-title'>🔍 Extracción de Características</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Detecta y extrae características visuales de imágenes</p>", unsafe_allow_html=True)

# ======== ARCHIVOS ========
files = {
    "./chapter5/prueba1.py": {"name": "Detección Rápida", "icon": "⚡"},
    "./chapter5/prueba2.py": {"name": "Detección de Esquinas", "icon": "📐"},
    "./chapter5/prueba3.py": {"name": "Detección ORB", "icon": "🎯"},
    "./chapter5/prueba4.py": {"name": "Detección SIFT", "icon": "🔬"},
    "./chapter5/prueba5.py": {"name": "Detección de Puntos Clave", "icon": "🔑"}
}
...
st.markdown("""
    <div class='footer'>
        <strong>Capítulo 5</strong> — Extracción de Características con OpenCV<br>
        Detección de puntos clave y descriptores
    </div>
""", unsafe_allow_html=True)