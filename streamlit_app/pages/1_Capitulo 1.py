...
st.set_page_config(
    page_title="Capítulo 1 - Transformaciones Geométricas",
    page_icon="🧩",
    layout="wide",
)
...
st.markdown("""
    <style>
        ...
        [data-testid="column"] {
            ...
            /* Contenedor principal con ancho del 70% */
        .block-container {
...
# ======== TÍTULO ========
st.markdown("<h1 class='main-title'>🧩 Transformaciones Geométricas</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Aplica transformaciones geométricas a imágenes con OpenCV</p>", unsafe_allow_html=True)

# ======== ARCHIVOS ========
files = {
    "./chapter1/prueba1.py": {"name": "Grises", "icon": "⚫"},
    "./chapter1/prueba2.py": {"name": "Traslación", "icon": "↔️"},
    "./chapter1/prueba3.py": {"name": "Rotación", "icon": "🔄"},
    "./chapter1/prueba4.py": {"name": "Escalado", "icon": "📏"},
    "./chapter1/prueba5.py": {"name": "Transformación", "icon": "✨"}
}
...
st.markdown("""
    <div class='footer'>
        <strong>Capítulo 1</strong> — Transformaciones Geométricas con OpenCV<br>
