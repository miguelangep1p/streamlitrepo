...
st.set_page_config(
    page_title="Capítulo 2 - Filtros y Bordes",
    page_icon="🌀",
    layout="wide",
)
...
# ======== TÍTULO ========
st.markdown("<h1 class='main-title'>🌀 Filtros y Bordes</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Detecta bordes y aplica filtros de procesamiento de imágenes</p>", unsafe_allow_html=True)

# ======== ARCHIVOS ========
files = {
    "./chapter2/prueba1.py": {"name": "Desenfoque", "icon": "🔹"},
    "./chapter2/prueba2.py": {"name": "Afilado", "icon": "✨"},
    "./chapter2/prueba3.py": {"name": "Realce", "icon": "💎"},
    "./chapter2/prueba4.py": {"name": "Erosión y Dilatación", "icon": "🔄"},
    "./chapter2/prueba5.py": {"name": "Viñeta", "icon": "🎨"}
}
...
st.markdown("""
    <div class='footer'>
        <strong>Capítulo 2</strong> — Filtros y Detección de Bordes con OpenCV<br>
