...
st.set_page_config(
    page_title="Capítulo 6 - Tallado de Costura",
    page_icon="✂️",
    layout="wide",
)
...
# ======== TÍTULO ========
st.markdown("<h1 class='main-title'>✂️ Tallado de Costura</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Redimensiona imágenes preservando contenido importante con Seam Carving</p>", unsafe_allow_html=True)

# ======== ARCHIVOS ========
files = {
    "./chapter6/prueba1.py": {"name": "Expandir Imagen", "icon": "📈"},
    "./chapter6/prueba2.py": {"name": "Reducir Imagen", "icon": "📉"},
    "./chapter6/prueba3.py": {"name": "Eliminar una Parte", "icon": "🗑️"}
}
...
# Crear grid de 2 columnas con espaciado (o 1 columna si es impar)
cols_per_row = 2
for i in range(0, len(script_items), cols_per_row):
    # Si quedan menos de 2 elementos, ajustar el número de columnas
    remaining = len(script_items) - i
...
st.markdown("""
    <div class='footer'>
        <strong>Capítulo 6</strong> — Tallado de Costura (Seam Carving) con OpenCV<br>
