...
st.set_page_config(
    page_title="Capítulo 10 - Realidad Aumentada",
    page_icon="🥽",
    layout="wide",
)
...
# ======== TÍTULO ========
st.markdown("<h1 class='main-title'>🥽 Realidad Aumentada</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Superpón elementos virtuales sobre el mundo real en tiempo real</p>", unsafe_allow_html=True)

# ======== ARCHIVOS ========
files = {
    "./chapter10/prueba1.py": {"name": "Superposición de Imágenes", "icon": "🖼️"},
    "./chapter10/prueba2.py": {"name": "Estimador de Posición", "icon": "📍"},
    "./chapter10/prueba3.py": {"name": "Pirámide 3D", "icon": "🔺"},
    "./chapter10/prueba4.py": {"name": "Detección de Movimiento", "icon": "🎯"}
}
...
st.markdown("""
    <div class='footer'>
        <strong>Capítulo 10</strong> — Realidad Aumentada con OpenCV<br>
        Integración de elementos virtuales en tiempo real
    </div>
""", unsafe_allow_html=True)