...
st.set_page_config(
    page_title="Capítulo 4 - Detección y Seguimiento",
    page_icon="🧠",
    layout="wide",
)
...
# ======== TÍTULO ========
st.markdown("<h1 class='main-title'>🧠 Detección y Seguimiento</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Selecciona un módulo para ejecutar y gestionar procesos de visión computacional</p>", unsafe_allow_html=True)

# ======== ARCHIVOS ========
files = {
    "./chapter4/prueba1.py": {"name": "Detección de Ojos", "icon": "👁️"},
    "./chapter4/prueba2.py": {"name": "Detección de Rostros", "icon": "🙂"},
    "./chapter4/prueba3.py": {"name": "Filtro de Rostro", "icon": "🎭"},
    "./chapter4/prueba4.py": {"name": "Detección de Labios", "icon": "👄"},
    "./chapter4/prueba5.py": {"name": "Detección de Nariz", "icon": "👃"}
}
...
st.markdown("""
    <div class='footer'>
        <strong>Capítulo 4</strong> — Visión Computacional con OpenCV<br>
