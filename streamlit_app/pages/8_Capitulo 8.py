...
st.set_page_config(
    page_title="Capítulo 8 - Seguimiento de Objetos",
    page_icon="📹",
    layout="wide",
)
...
# ======== TÍTULO ========
st.markdown("<h1 class='main-title'>📹 Seguimiento de Objetos</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Rastrea y sigue objetos en movimiento en tiempo real</p>", unsafe_allow_html=True)

# ======== ARCHIVOS ========
files = {
    "./chapter8/prueba1.py": {"name": "Detectar Movimientos", "icon": "🏃"},
    "./chapter8/prueba2.py": {"name": "Espacio de Color", "icon": "🎨"},
    "./chapter8/prueba3.py": {"name": "Seguimiento de Espacios de Color", "icon": "🌈"},
    "./chapter8/prueba4.py": {"name": "Seguimiento Basado en Funciones", "icon": "⚙️"},
    "./chapter8/prueba5.py": {"name": "Seguimiento de Fondo", "icon": "🖼️"}
}
...
st.markdown("""
    <div class='footer'>
        <strong>Capítulo 8</strong> — Seguimiento de Objetos con OpenCV<br>
        Detección y rastreo de movimientos en video
    </div>
""", unsafe_allow_html=True)